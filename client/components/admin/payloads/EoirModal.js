...
class EoirModal extends React.Component {
  ...
  render() {
    ...
    const crewFields = [
      ...
      {name: translations['MOS#1'], type: 'input', domID: 'PayloadMos1', valFieldID: 'PayloadMOS1'},
      {name: translations['MOS#2'], type: 'input', domID: 'PayloadMos2', valFieldID: 'PayloadMOS2'},
      {name: translations['MOS#3'], type: 'input', domID: 'PayloadMos3', valFieldID: 'PayloadMOS3'},
    ];
